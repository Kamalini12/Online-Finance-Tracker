...
app = Flask(__name__)
app.secret_key = 'everease_secret_key'

users = {
    "Adi": {"password": "0024", "budget": None, "expenses": []},
    "Jay": {"password": "0063", "budget": None, "expenses": []},
    "Hari Priya": {"password": "0234", "budget": None, "expenses": []},
    "Kamalini": {"password": "0683", "budget": None, "expenses": []}
}
